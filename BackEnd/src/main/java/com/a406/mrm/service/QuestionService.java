...
public interface QuestionService {
    ...
    QuestionResponseAnswerDto join(String title, String content, String user_id, int room_id, MultipartFile picture) throws Exception;
    ...
    Page<QuestionResponseDto> listQuestion_Pageable(int room_id, Pageable pageable);
